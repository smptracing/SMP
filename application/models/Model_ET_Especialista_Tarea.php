...
class Model_ET_Especialista_Tarea extends CI_Model
{
	...
	{
		$data=$this->db->query("select * from ET_ESPECIALISTA_TAREA as etet inner join ESPECIALIDAD as e on etet.id_esp=e.id_esp left join ET_PER_REQ as etpr on etet.id_per_req=etpr.id_per_req");
