...
class Estudio_Inversion_Model extends CI_Model
{
    ...
    public function get_EstudioInversion()
    {
        ...
        $sql = "select ei.id_est_inv, nombre_est_inv, pe.id_persona, (pe.nombres +' '+pe.apellido_p +' '+ pe.apellido_m) as nombres,  fecha,avance_fisico, denom_etapas_fe\n"
            ...
            . " left outer join RESPONSABLE_ESTUDIO re on re.id_est_inv = ei.id_est_inv\n"
