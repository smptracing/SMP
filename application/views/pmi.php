                ...
                <div class="x_content">
                    <div class="widget_summary">
                        ...
                        <div class="w_center w_25">
                            <div class="progress">
                                <div id="idprogressAbanc" class="progress-bar bg-green" role="progressbar"
                    ...
                    <div class="widget_summary">
                        ...
                        <div class="w_center w_25">
                            <div class="progress">
                                <div class="progress-bar bg-green" role="progressbar" aria-valuenow="10"
                            ...
                            <li>
                                <div class="block">
                                    <div class="block_content">
                                        ...
                                        <p class="excerpt">CANTIDAD DE PROYECTOS:
                            ...
                            <li>
                                <div class="block">
                                    <div class="block_content">
                                        ...
                                        <p class="excerpt">CANTIDAD DE PROYECTOS:<a id="CantidadPChincheros"></a>
                                        </p>
                                        <p class="excerpt">MONTO TOTAL:</a>
                                        </p>
                                    </div>
                            ...
                            <li>
                                <div class="block">
                                    <div class="block_content">
                                        ...
                                        <p class="excerpt">CANTIDAD DE PROYECTOS:<a id="CantidadPGrau"></a>
                                        </p>
                                        <p class="excerpt">MONTO TOTAL:</a>
                                        </p>
                                    </div>
