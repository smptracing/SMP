          ...
          <div class="">
            ...
            <div class="">
              <div class="col-md-12 col-sm-6 col-xs-12">
                                <div class="x_panel">
                                  <div class="x_title">
                                    <h2><i class="fa fa-bars"></i> UBICACIÓN GEOGRÁFICA <small></small></h2>
                                  ...
                                  <div class="x_content">
                                    ...
                                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                      ...
                                      <div id="myTabContent" class="tab-content">
                                           <!-- /panel de ubigeo -->
                                        <div role="tabpanel" class="tab-pane fade active in" id="tab_Ubigeo" aria-labelledby="home-tab">
                                             <!-- /tabla de ubigeo row -->
                                            <div class="row">
                            ...
                            <!-- /  panel de modalidad ejecucion el row -->
                                        <div role="tabpanel" class="tab-pane fade" id="tab_ModalidadEjecucion" aria-labelledby="profile-tab">
                                            ...
                                            <div class="row">
                                                  ...
                                                  <div class="col-md-12 col-sm-12 col-xs-12">
                                                        <div class="x_panel">
                                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#VentanaRegistraModalidadEjecucion" >Nueva Ubigeo</button>
                                                          <div class="x_title">
                                ...
                                <!-- /  Panel Unidad Ejecutora -->
                                         <div role="tabpanel" class="tab-pane fade" id="tab_UnidadEjecutora" aria-labelledby="profile-tab">
                                            ...
                                            <div class="row">
                                                  ...
                                                  <div class="col-md-12 col-sm-12 col-xs-12">
                                                        <div class="x_panel">
                                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#VentanaRegistraUnidadEjecutora" >Nueva unidad ejecutora</button>
                                                          <div class="x_title">
...
<!-- /.ventana para registrar un ubigeo-->
<div class="modal fade" id="VentanaRegistraUbigeo" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Ver Ubicaciones</h4>
        </div>
        <div class="modal-body">
         <div class="row">
                    <div class="col-xs-12">
                                        <!-- PAGE CONTENT BEGINS -->
                    <form class="form-horizontal form-label-left " id="formUbicacion" name="formUbicacion" >
...
<!-- /.fin ventana para registra un nuevo ubigeo-->
