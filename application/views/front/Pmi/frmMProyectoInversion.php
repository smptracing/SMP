         ...
         <div class="row">
            ...
            <form class="form-horizontal " id="form-addBrecha" action="<?php echo  base_url();?>MProyectoInversion/AddProyectoInversion" method="POST" >
                      ...
                      <div class="item form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input id="" name="" class="form-control col-md-7 col-xs-5" data-validate-length-range="6" data-validate-words="2" placeholder="Devengado" required="required" type="text">
                          </div>
                      </div>
                       <div class="item form-group">
