            ...
            <div class="">
              <div class="col-md-12 col-sm-6 col-xs-12">
                                  ...
                                  <div class="x_content">
                                    ...
                                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                      ...
                                      <div id="myTabContent" class="tab-content">
                                           <!-- /panel de ejecucion  -->
                                        <div role="tabpanel" class="tab-pane fade active in" id="tab_RubroEjecucion" aria-labelledby="home-tab">
                            ...
                            <!-- /  panel de modalidad ejecucion el row -->
                                        <div role="tabpanel" class="tab-pane fade" id="tab_ModalidadEjecucion" aria-labelledby="profile-tab">
