...
<body>
    ...
    <div class="wrapper wrapper-full-page">
        <div class="full-page login-page" filter-color="black" data-image="<?php echo base_url(); ?>assets/Img/laguna6.jpg" style ="-webkit-filter: grayscale(25%); filter: grayscale(25%);">
