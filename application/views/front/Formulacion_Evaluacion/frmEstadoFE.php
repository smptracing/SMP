          ...
          <div class="">
            ...
            <div class="">
              <div class="col-md-12 col-xs-12">
                                <div class="x_panel">
                                  <div class="x_title">
                                    <h2><i class="fa fa-bars"></i>Estado Formulación Evaluación</h2>
                                  ...
                                  <div class="x_content">
                                    ...
                                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                      <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                        <li role="presentation" class="active"><a href="#tab_estado" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true"> <span class="glyphicon glyphicon-inbox" aria-hidden="true"></span>Estado</a>
                                        </li>                           
                                      </ul>
         ...
         <div class="row">
                ...
                <form class="form-horizontal " id="form-updateEstadoFE"  method="POST" >
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           <input id="id_estado" name="id_estado" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2"   required="required" type="text">
