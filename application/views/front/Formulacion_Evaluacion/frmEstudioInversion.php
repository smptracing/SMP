...
<div class="modal fade" id="ventana_asignar_coordinador" role="dialog">
    <div class="modal-dialog ">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title"><span class="glyphicon glyphicon-inbox" aria-hidden="true"></span>
          Asignar Coordinador </h4>
        </div>
        <div class="modal-body">
         <div class="row">
                    <div class="col-xs-12">
                                        <!-- PAGE CONTENT BEGINS -->
              <form class="form-horizontal " id="form-AddCoordinadorEstudio"   action="<?php echo base_url(); ?>Estudio_Inversion/AddCoordinadorEstudio" method="POST" >
                                       ...
                                       <div class="col-md-8">
                                          <br>
                                           <label for="name">Responsable<span class="required"></span>
                                                 ...
                                                 <select   id="listaResponsables" name="listaResponsables" class="selectpicker form-control col-md-12 col-xs-12" data-live-search="true"  title="Buscar Coordinador...">
                                                </select>
                                          </div>
                                           <div class="col-md-4">
                                          <br>
