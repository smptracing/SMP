          ...
          <div class="">
            ...
            <div class="">
              <div class="col-md-12 col-xs-12">
                                <div class="x_panel">
                                  <div class="x_title">
                                    <h2><i class="fa fa-bars"></i>Documentos</h2>
                                  ...
                                  <div class="x_content">
                                    ...
                                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                      <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                        <li role="presentation" class="active"><a href="#tab_documento" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true"> <span class="glyphicon glyphicon-inbox" aria-hidden="true"></span>Documentos de Inversión</a>
                                        </li>
                                        <li role="presentation" class=""><a href="#tab_tipo_estudioFE" role="tab"  id="profile-tab" data-toggle="tab" aria-expanded="false"> <span class="glyphicon glyphicon-inbox" aria-hidden="true"></span>Tipos de Estudios</a>
                                        </li>
                                      ...
                                      <div id="myTabContent" class="tab-content">
                                        ...
                                        <div role="tabpanel" class="tab-pane fade active in" id="tab_documento" aria-labelledby="home-tab">
                                        ...
                                        <div role="tabpanel" class="tab-pane fade" id="tab_tipo_estudioFE" aria-labelledby="profile-tab">
         ...
         <div class="row">
                ...
                <form class="form-horizontal " id="form-addTipoEstudioFE"  method="POST" >
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Tipo Estudio<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="txt_tipoEstudioFE" name="txt_tipoEstudioFE" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2"   required="required" type="text">
                        </div>
                      </div>
