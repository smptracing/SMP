           ...
           <div class="row">
                  ...
                  <form class="form-horizontal " id="form-UpdateTipoEstudioFE"  method="POST" >
                        ...
                        <div class="item form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input id="id_tipoEstudioFEModi" name="id_tipoEstudioFEModi" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2"   required="required" type="hidden">
                            <input id="txt_tipoEstudioFEModi" name="txt_tipoEstudioFEModi" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2"   required="required" type="text">
                          </div>
                        </div>
