        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form class="form-horizontal " id="form-EditNaturalezaInversion"   action="<?php echo base_url(); ?>TipologiaInversion/get_NaturalezaInversion" method="POST" >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form class="form-horizontal " id="form-AddNaturalezaInversion"   action="<?php echo base_url(); ?>TipologiaInversion/AddNaturalezaInversion" method="POST" >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form class="form-horizontal " id="form-AddTipologiaInversion"   action="<?php echo base_url(); ?>TipologiaInversion/AddTipologiaInversion" method="POST" >
                            <div class="item form-group">
