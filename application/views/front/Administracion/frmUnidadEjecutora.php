            ...
            <div class="">
              <div class="col-md-12 col-sm-6 col-xs-12">
                            ...
                            <!-- /  panel de modalidad ejecucion el row -->
                                ...
                                <!-- /  Panel Unidad Formuladora -->
                                         <div role="tabpanel" class="tab-pane fade" id="tab_UnidadFormuladora" aria-labelledby="profile-tab">
                                                <!-- /tabla de Unidad Formuladora row -->
                                            <div class="row">
                                                  <div class="col-md-12 col-sm-12 col-xs-12">
                                                        <div class="x_panel">
                                         ...
                                         <!-- / fin  Unidad Formuladora-->
                                         </div>
                                <!-- /  Fin Panel Unidad Formuladora -->
...
<div class="modal fade" id="VentanaModificarModalidadE" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Modificar Modalidad de Ejecucion</h4>
        </div>
        <div class="modal-body">
         <div class="row">
                <div class="col-xs-12">
...
<div class="modal fade" id="VentanaRegistraUnidadEjecutora" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Registrar Nueva Unidad Ejecutora</h4>
        </div>
        <div class="modal-body">
         <div class="row">
                    <div class="col-xs-12">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="txt_NombreUnidadE" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="txt_NombreUnidadE" placeholder="Nombre Unidad Ejecutora" required="required" type="text">
                        </div>
                      </div>
                      <div class="ln_solid"></div>
                      <div class="form-group">
...
<div class="modal fade" id="VentanaModificarUnidadE" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Modificar Unidad Ejecutora</h4>
        </div>
        <div class="modal-body">
         <div class="row">
                <div class="col-xs-12">
                ...
                <form class="form-horizontal " id="form-ActualizarUnidadE" action="<?php echo base_url(); ?>UnidadE/UpdateUnidadE" method="POST" >
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="txt_IdUnidadEModif" type="hidden" name="txt_IdUnidadEModif" type="text">
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="txt_NombreUnidadEU" name="txt_NombreUnidadEU" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="name"  required="required" type="text">
                        </div>
                      </div>
...
<div class="modal fade" id="VentanaRegistraUnidadFormuladora" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Registrar Nueva Unidad Formuladora</h4>
        </div>
        <div class="modal-body">
         <div class="row">
                    <div class="col-xs-12">
                                        <!-- PAGE CONTENT BEGINS -->
                      <form class="form-horizontal form-label-left"  id="form-addUnidadF" action="<?php echo base_url(); ?>UnidadF/AddUnidadF" method="POST">

                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Nombre <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="txt_NombreUnidadF" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="txt_NombreUnidadF" placeholder="Nombre Unidad Formuladora" required="required" type="text">
                        </div>
                      </div>
                      <div class="ln_solid"></div>
                      <div class="form-group">
...
<div class="modal fade" id="VentanaModificarUnidadF" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Modificar Unidad Formuladora</h4>
        </div>
        <div class="modal-body">
         <div class="row">
                <div class="col-xs-12">

<form class="form-horizontal " id="form-ActualizarUnidadF" action="<?php echo base_url(); ?>UnidadF/GetUnidadF" method="POST" >
      <div class="item form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="txt_IdUnidadFModif" name="txt_IdUnidadFModif" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2"  placeholder="ID" required="required" type="hidden">
                        </div>
                      </div>

                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Nombre unidad Formuladora<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="txt_NombreUnidadFU" name="txt_NombreUnidadFU" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="name"  required="required" type="text">
                        </div>
                      </div>
