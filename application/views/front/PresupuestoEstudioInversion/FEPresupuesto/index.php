														...
														<?php foreach($ListarPresupuesto as $item ){ ?>
															<tr>
																...
																<td>
																  	...
																  	<button class='btn btn-success btn-xs' onclick="paginaAjaxDialogo(null, 'Fuentes y Detalle de presupuesto',{ id: '<?=$item->id_presupuesto_fe?>', id_est_inv: '<?=$nombreProyectoInv->id_est_inv?>' }, base_url+'index.php/FE_Presupuesto_Inv/verDetalle', 'GET', null, null, false, true)" ><i class='ace-icon fa fa-eye bigger-120'></i></button>
																	<a type="button" class="btn btn-round btn-success" href="<?= site_url('FE_Presupuesto_Inv/reportePdfDetalleGasto/'.$item->id_presupuesto_fe);?>" target="_blank"><i class='ace-icon fa fa-file-pdf-o bigger-120'></i></a>
