													...
													<tbody>
														<?php foreach($ListarPresupuesto as $item ){ ?>
															<tr>
																...
																<td>
																  	<button class='btn btn-success btn-xs' onclick="paginaAjaxDialogo(null, 'Fuentes y Detalle de presupuesto',{ id: '<?=$nombreProyectoInv->id_est_inv?>', idpresupuesto: '<?=$item->id_presupuesto_fe?>'}, base_url+'index.php/FE_Presupuesto_Inv/verDetalle', 'GET', null, null, false, true)" ><i class='ace-icon fa fa-eye bigger-120'></i></button>
