<form class="form-horizontal " id="form-EditarTipoGastoFE"  action="<?php echo base_url();?>index.php/Tipo_Gasto_FE/editar" method="POST" >
	<div class="item form-group">
		...
		<div class="col-md-6 col-sm-6 col-xs-12">
			...
			<input id="txt_descripcion_tipo" name="txt_descripcion_tipo" value="<?=$TipoGastoFE->desc_tipo_gasto;?>" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2"  placeholder="Ingrese Tipo de Gasto" required="required" type="text">
		</div>
	</div>
