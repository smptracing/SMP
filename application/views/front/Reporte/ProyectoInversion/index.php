		...
		success: function(data)
			{
				...
				$.each( meta1, function( key, value ) {
				 	...
				 	html +="<tbody> <tr><th><button type='button' class='editar btn btn-success btn-xs' onclick='detalladoMensualizado("+value.ano_eje+","+parseInt(value.meta)+");'>"+parseInt(value.ano_eje)+" <i class='ace-icon'></i></button></th><th><button type='button' class='editar btn btn-primary btn-xs' onclick='detalladoMensualizadoFuenteFinan("+value.ano_eje+","+parseInt(value.meta)+");'>"+parseInt(value.meta)+"<i class='ace-icon bigger-120'></i></button></th><th> <div class='dropdown'>  <a class='btn btn-link dropdown-toggle' type='button' data-toggle='dropdown'> <span class='glyphicon glyphicon-option-vertical' aria-hidden='true'></span></a> <ul class='dropdown-menu pull-left' style=''> <li><button type='button' title='Detalle de la meta' class='DocumentosEstudio btn btn-link btn-xs' onclick='detalladoMensualizadoFuenteFinan("+value.ano_eje+","+parseInt(value.meta)+");'> Fuente financiamiento</button> </li><li><button type='button' title='Detalle de la meta' class='DocumentosEstudio btn btn-link btn-xs' onclick='detalladoMensualizado("+value.ano_eje+","+parseInt(value.meta)+"); '> Detalle de la meta</button> </li><li><button type='button' title='Orden del Pedido' class='DocumentosEstudio btn btn-link btn-xs'  onclick='detalladoMensualizadoConceptoClasificador("+value.ano_eje+","+parseInt(value.meta)+");'> Orden</button> </li> <li><button type='button' title='Orden del Pedido' class='DocumentosEstudio btn btn-link btn-xs'  onclick='detallePedidoCompraMeta("+value.ano_eje+","+parseInt(value.meta)+");'> Pedido</button> </li> </ul> </div></th><th style='text-align:right'>"+value.pia+"</th><th style='text-align:right'>"+value.pim+"</th><th style='text-align:right'>"+value.pim_acumulado+"</th><th style='text-align:right'>"+value.ejecucion+"</th><th style='text-align:right'>"+value.compromiso+"</th><th style='text-align:right'>"+value.monto_certificado+"</th><th style='text-align:right'>"+value.devengado+"</th><th style='text-align:right'>"+value.girado+"</th><th style='text-align:right'>"+value.pagado+"</th><th style='text-align:right'>"+value.avance_financiero+'%'+"</th><th style='text-align:right'>"+value.monto_comprometido_anual+"</th><th style='text-align:right'>"+value.monto_precertificado+"</th></tr>";      
						html +="</tbody>";
				});
