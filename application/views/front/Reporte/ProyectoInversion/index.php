		...
		success: function(data)
			{
		        ...
		        var html;
				html+="<thead><tr><th>Año Ejec</th><th>Meta</th><th style='text-align:right'>Pia</th><th style='text-align:right'>Pim</th><th style='text-align:right'>Pim Acum.</th><th style='text-align:right'>Ejecución</th><th style='text-align:right'>Compromiso</th><th style='text-align:right'>Monto Certificado</th><th style='text-align:right'>Devengado</th><th style='text-align:right'>Girado</th><th style='text-align:right'>Pagado</th><th style='text-align:right'>Avan Fin.</th><th style='text-align:right'>Monto comprometido</th><th style='text-align:right'>Monto precertificado</th><th>Ver</th></tr></thead>"
				$.each( meta1, function( key, value ) {
                   	html +="<tr>";
                              html +="<th  colspan='15'>"+value.nombre_finalidad+"</th></tr> <tr>";
				 	html +="<tbody> <tr><th style='text-align:right'>"+value.ano_eje+"</th><th style='text-align:right'>"+parseInt(value.meta)+"</th><th style='text-align:right'>"+value.pia+"</th><th style='text-align:right'>"+value.pim+"</th><th style='text-align:right'>"+value.pim_acumulado+"</th><th style='text-align:right'>"+value.ejecucion+"</th><th style='text-align:right'>"+value.compromiso+"</th><th style='text-align:right'>"+value.monto_certificado+"</th><th style='text-align:right'>"+value.devengado+"</th><th style='text-align:right'>"+value.girado+"</th><th style='text-align:right'>"+value.pagado+"</th><th style='text-align:right'>"+value.avance_financiero+'%'+"</th><th style='text-align:right'>"+value.monto_comprometido_anual+"</th><th style='text-align:right'>"+value.monto_precertificado+"</th><th><div class='dropdown'>  <a class='btn btn-link dropdown-toggle' type='button' data-toggle='dropdown'> <span class='glyphicon glyphicon-option-vertical' aria-hidden='true'></span></a> <ul class='dropdown-menu pull-right' style=''> <li><button type='button' title='Detalle de la meta' class='DocumentosEstudio btn btn-link btn-xs' onclick='detalladoMensualizadoFuenteFinan("+value.ano_eje+","+parseInt(value.meta)+");'> Detalle fuente financiamiento</button> </li><li><button type='button' title='Detalle de la meta' class='DocumentosEstudio btn btn-link btn-xs' onclick='detalladoMensualizado("+value.ano_eje+","+parseInt(value.meta)+"); '> Detalle de la meta</button> </li><li><button type='button' title='Orden del Pedido' class='DocumentosEstudio btn btn-link btn-xs'  onclick='detalladoMensualizadoConceptoClasificador("+value.ano_eje+","+parseInt(value.meta)+");'> Orden</button> </li> <li><button type='button' title='Orden del Pedido' class='DocumentosEstudio btn btn-link btn-xs'  onclick='detallePedidoCompraMeta("+value.ano_eje+","+parseInt(value.meta)+");'> Pedido</button> </li> </ul> </div></th></tr>";      
						html +="</tbody>";
				});
