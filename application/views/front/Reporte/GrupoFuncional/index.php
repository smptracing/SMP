											...
											<div class="x_panel">
													...
													<div class="col-md-4 col-sm-12 col-xs-12">
														<table id="table-Resumen"  class="table">
																<tr>
																<td colspan="2"><b>CUADRO RESUMEN DE PIP POR GRUPO FUNCIONAL</b></td>
																</tr>
																<tr>
																	<td>TOTAL PIP</td>
																...
																<tr>
																	...
																	<td bgcolor="#D1F2EB">
																		S/. <?= a_number_format($listaMontoTotalGrupoFuncional->CostoPip, 2, '.',",",3);?>
																	</td>
																	<td bgcolor="#D1F2EB"><?=$listaMontoTotalGrupoFuncional->CantidadPip;?></td>
																</tr>
														</table> 
													</div>
											</div>
