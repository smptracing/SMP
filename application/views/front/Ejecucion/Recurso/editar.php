<form class="form-horizontal" id="form-EditarRecurso" action="<?php echo base_url();?>index.php/Recurso/editar" method="POST">
	<div class="item form-group">
		...
		<div class="col-md-6 col-sm-6 col-xs-12">
			...
			<input id="txtDescripcion" name="txtDescripcion" value="<?=$recurso->descripcion;?>" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" required="required" autocomplete="off" type="text">
		</div>
	</div>
