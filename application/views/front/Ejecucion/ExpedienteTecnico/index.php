								...
								<?php foreach($listaExpedienteTecnicoElaboracion as $item){ ?>
								  	<tr>
										...
										<td>
											...
											<button type="button" data-toggle="tooltip" data-original-title="Valororización de ejecución del proyecto" class="btn btn-success btn-xs" onclick="window.open(base_url+'index.php/Expediente_Tecnico/valorizacionEjecucionProyecto/<?=$item->id_et?>', '_blank');"><i class="fa fa-check"></i></button>
											<div class="btn-group">
