							...
							<table id="table-ExpedienteTecnico" style="text-align: center;" class="table table-striped jambo_table bulk_action  table-hover" cellspacing="0" width="100%">
								...
								<?php foreach($listaExpedienteTecnicoElaboracion as $item){ ?>
								  	<tr>
										...
										<td>
									  		<button type='button' data-toggle="tooltip" data-original-title="Gestionar actividades" class='btn btn-success btn-xs' onclick="window.open(base_url+'/index.php/ET_TAREA_GANTT/index/<?=$item->id_et?>', '_blank');"><i class="glyphicon glyphicon-fullscreen"></i></button>
