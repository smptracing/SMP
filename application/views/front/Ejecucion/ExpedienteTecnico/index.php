								...
								<?php foreach($listaExpedienteTecnicoElaboracion as $item){ ?>
								  	<tr>
										...
										<td>
											...
											<button type='button' data-toggle="tooltip" data-original-title="Visto Bueno del E.T."   class='btn btn-success btn-xs' onclick="paginaAjaxDialogo(null, 'Visto Bueno del E.T.', { id_ExpedienteTecnico : <?=$item->id_et?> }, base_url+'index.php/Expediente_Tecnico/vistoBueno', 'GET', null, null, false, true);"><i class="fa fa-check"></i></button>
