        ...
        <div class="left_col scroll-view">
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                    <li><a href="<?php echo site_url('Usuario/'); ?>"><i class="fa fa-suitcase"></i>Monitoreo</a></li>
                </ul>
        ...
        <div class="nav_menu">
          <nav>
            <div class="nav toggle" style="position: relative;">
                        ...
                        <div id="navtittle"  >
                        <span style="position: absolute;top: 14px;left: 50px; width: 700px; font-size: 20px; text-shadow: 1px 1px 1px rgba(0,0,0,0.3);">Monitoreo de Proyectos de Inversión</span>
                        </div>

                        <div id="navtittlemin">
                        <span style="position: absolute;top: 14px;left: 50px; width: 700px; font-size: 20px; text-shadow: 1px 1px 1px rgba(0,0,0,0.3);">Monitoreo</span></div>
            </div>
