		...
		<div class="main_container">
			<div class="col-md-3 left_col">
              ...
              <ul class='nav side-menu'>
                <li><a href="<?php echo site_url('PrincipalMonitoreo/PrincipalMonitoreo'); ?>"> <i class="fa fa-home"></i> INICIO<span class=""></span></a></li>
                <?php
                  $openTag=false;
                  $arrayMenu=$this->session->userdata('menuUsuario');
                  for($i=0;$i<count($arrayMenu);$i++){
                  if($arrayMenu[$i]['id_modulo']=='M'){
					...
					<nav>
						<div class="nav toggle" style="position: relative;">
			                <a id="menu_toggle"><i class="fa fa-bars"></i></a>
			                  <div id="navtittle"  >
			                  <span style="position: absolute;top: 14px;left: 50px; width: 700px; font-size: 20px; text-shadow: 1px 1px 1px rgba(0,0,0,0.3);">Monitoreo de Proyectos</span>
			                  </div>

			                  <div id="navtittlemin">
			                  <span style="position: absolute;top: 14px;left: 50px; width: 700px; font-size: 20px; text-shadow: 1px 1px 1px rgba(0,0,0,0.3);">MP</span></div>
			              </div>
