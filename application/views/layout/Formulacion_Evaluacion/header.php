                    ...
                    <ul class="nav side-menu">
                      <li><a><i class="fa fa-database"></i> Principal <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                          ...
                          <li><a href="<?php echo site_url('EvaluacionFE/FeEvaluaciones'); ?>">Evaluación Monitor</a></li>
                           <li><a href="<?php echo site_url('EvaluacionEvaluadorFE/FeEvaluaciones'); ?>">Evaluación Evaluador</a></li>
