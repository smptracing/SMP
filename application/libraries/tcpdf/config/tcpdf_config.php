 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'SOCIEDAD DE BENEFICENCIA PÚBLICA DE ABANCAY');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Visitenos en: www.sbpabancay.gob.pe ");
 ...
 */
define ('PDF_FONT_SIZE_MAIN', 9);//CABECERa
