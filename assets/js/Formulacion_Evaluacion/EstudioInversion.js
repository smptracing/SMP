...
var eliminarEtapaEstado=function(idEtapaestudio,element)
{
 ...
 {"defaultContent":" <div class='btn-group'> <button data-toggle='dropdown' class='btn btn-default dropdown-toggle' type='button' aria-expanded='false'>Opciones <span class='caret'></span> </button> <ul class='dropdown-menu'> <li><button type='button' title='Subir Resolución' class='DocumentosEstudio btn btn-info btn-xs' data-toggle='modal' data-target='#VentanaDocumentosEstudio'><i class='fa fa-flag' aria-hidden='true'></i> Documento</button> </li>  <li> <button type='button' title='Asignar Respondable' class='AsignarPersona btn btn-warning btn-xs' data-toggle='modal' data-target='#ventanaasiganarpersona'><i class='fa fa-spinner' aria-hidden='true'></i>Asignar Coordinador</button></li>   <li><button type='button' title='Nueva Etapa Estudio' class='nuevaEtapaEstudio btn btn-success btn-xs' data-toggle='modal' data-target='#ventanaEtapaEstudio'><i class='fa fa-map-marker' aria-hidden='true'></i>Nueva Etapa de Estudio</button> </li>   <li> <button type='button' title='Ver Etapas Estudio' class='ver_etapas_estudio btn btn-info btn-xs' data-toggle='modal' data-target='#ventana_ver_etapas_estudio'><i class='fa fa-paw' aria-hidden='true'></i>Ver Etapas</button></li> </ul> </div>"}
